...
SELECT Name, count(Name) AS Unique_City_Names
FROM world.city
GROUP BY Name
ORDER BY Name asc;
...
SELECT city.ID, city.Name, city.Population, country.GovernmentForm, country.HeadOfState, country.Capital
FROM country
JOIN city ON country.Capital = city.ID
WHERE country.Name = 'Spain';

SELECT city.Name, city.CountryCode, country.Code, country.Name, country.Continent
FROM country
...
SELECT city.ID, country.Capital, country.Name, city.Name, city.Population
FROM country
JOIN city ON country.Capital = city.ID;
...
SELECT city.Name, city.ID, country.Capital, country.Name, city.Population, country.GNP,
(sum(country.GNP)/sum(city.Population)) AS City_GDP
FROM country
GROUP BY city.Name
JOIN city ON country.Capital = city.ID;
...
SELECT city.ID, country.Capital, country.Name, city.Name, city.Population, country.GNP,
(sum(country.GNP)/sum(city.Population) AS City_GDP
FROM world.country
GROUP BY city.Name
JOIN city ON country.Capital = city.ID;
